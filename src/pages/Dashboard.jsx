...
export default function Dashboard() {
  ...
  return (
    <div className="dashboard-container">
      <p className="greet">Hello Roger👋🏻,</p>
       ...
       <div className="lead-status">
            <ul>
              <li><div className="img-div"><img src="/profile-user.svg" alt="Customer" /></div><div className="text-div"><p className="p1">New Lead</p><p className="p2">{lead.filter(l => l.leadstatus === "New").length}</p></div></li>
              <li><div className="img-div"><img src="/monitor.svg" alt="Contacted-Customer" /></div><div className="text-div"><p className="p1">Contacted</p><p className="p2">{lead.filter(l => l.leadstatus === "Contacted").length}</p></div></li>
              <li><div className="img-div"><img src="/Proposal-sent.svg" alt="Proposal-Sent" className="proposal-sent" /></div><div className="text-div"><p className="p1">Proposal Sent</p><p className="p2">{lead.filter(l => l.leadstatus === "Proposal Sent").length}</p></div></li>
              <li><div className="img-div"><img src="/profile-tick.svg" alt="Qualified-Customer" /></div><div className="text-div"><p className="p1">Qualified</p><p className="p2">{lead.filter(l => l.leadstatus === "Qualified").length}</p></div></li>
            </ul>
        </div>
    ...
    <div className="shorting-leads">
      <label htmlFor="leadStatus">Short by: </label>
